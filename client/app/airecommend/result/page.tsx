                ...
                <div className="flex flex-col justify-between flex-1">
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-2 w-full py-3 rounded-xl
                        bg-[#F1F5F2] text-[#7C9885] text-[13px] font-bold border border-[#7C9885]/10
      ...
      <div className="mt-12">
        <button
          ...
          className="w-full flex items-center justify-center gap-2 py-4 rounded-xl
                bg-white border border-[#F3F4F6] text-[#9CA3AF] text-[13px] font-medium transition-all hover:bg-[#F9FAFB]"
        >
          <RefreshCcw size={15} />
          다시 추천받기
        </button>
